...
defined("IMAGES_PATH_BASEDIR") ? null : define("IMAGES_PATH_BASEDIR", __DIR__ . DS . ".." . DS . "public" );
defined("IMAGES_PATH") ? null : define("IMAGES_PATH", __DIR__ . DS . ".." . DS . "public" . DS . "admin" . DS . "images" );
